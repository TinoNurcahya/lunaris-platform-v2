...
const FAQ_DATA: FAQItem[] = [
  {
    ...
    answer: 'Lunarys v2 adalah platform sosial modern bagi komunitas penulis, pencipta kata mutiara, dan penikmat musik di Indonesia untuk saling berbagi kutipan inspiratif, lirik lagu favorit, dan filosofi hidup.'
  },
  {
    id: 'faq-2',
    category: 'account',
    ...
    answer: 'Ya! Anda dapat masuk atau mendaftar secara instan dalam 1 klik menggunakan tombol "Masuk dengan Google" pada halaman Login maupun Pendaftaran.'
  },
  {
    id: 'faq-3',
    ...
    answer: 'Setiap kali Anda membuat kutipan baru (+50 XP), memberikan tanggapan suka (+10 XP), atau berkomentar (+5 XP), XP Anda akan bertambah secara otomatis dan menaikkan Level profil Anda di Leaderboard.'
  },
  {
    id: 'faq-4',
    category: 'features',
    ...
    answer: 'Saat membuat atau mengedit kutipan, Anda dapat memasukkan tautan (URL) lagu Spotify. Player musik Spotify interaktif beserta cuplikan lirik akan tampil secara otomatis di kartu kutipan Anda.'
  },
  {
    id: 'faq-5',
    category: 'features',
    ...
    answer: 'Klik ikon Jarum Semat (Pin) pada kartu kutipan milik Anda sendiri. Kutipan yang disematkan akan selalu tampil di bagian paling atas halaman profil Anda.'
  },
  {
    id: 'faq-6',
    category: 'general',
...
export default function FAQPage() {
  ...
  return (
    <div className="space-y-8 pb-12 max-w-4xl mx-auto">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 via-indigo-700 to-blue-700 p-8 sm:p-10 text-white shadow-lg">
        <div className="relative z-10 space-y-3">
          ...
          <p className="text-xs sm:text-sm text-indigo-100 max-w-xl leading-relaxed">
            Temukan jawaban lengkap seputar cara penggunaan Lunarys, fitur lirik lagu, sistem level & XP, serta manajemen akun.
          </p>
          ...
          <div className="pt-2 max-w-md">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl pl-10 pr-4 py-3 text-xs text-slate-800 dark:text-slate-100 shadow-md focus:outline-none focus:ring-2 focus:ring-amber-400 transition-all placeholder:text-slate-400"
              />
            </div>
          </div>
        </div>
      ...
      {/* CTA Bottom Card */}
      <div className="bg-gradient-to-br from-indigo-50 to-slate-100 dark:from-slate-900 dark:to-indigo-950/40 border border-indigo-100 dark:border-indigo-900/50 rounded-2xl p-6 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
