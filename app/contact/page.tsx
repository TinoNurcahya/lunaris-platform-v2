    ...
    <div className="space-y-8 pb-12 max-w-4xl mx-auto">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-indigo-600 p-8 sm:p-10 text-white shadow-lg">
        <div className="relative z-10 space-y-3">
          ...
          <h1 className="text-2xl sm:text-4xl font-bold tracking-tight">Hubungi Kami</h1>

          <p className="text-xs sm:text-sm text-indigo-100 max-w-xl leading-relaxed">
            Punya pertanyaan, kendala penggunaan, kritik & saran, atau ide kerja sama? Kirimkan pesan langsung
            kepada tim pengembang Lunarys V2.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-2xl p-6 shadow-sm space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                Kirim email langsung kapan saja.
              </p>
            </div>
          ...
          {/* Quick Info Box */}
          <div className="bg-indigo-50 dark:bg-slate-900 border border-indigo-100 dark:border-indigo-900/50 rounded-2xl p-5 shadow-sm space-y-2">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-800 pb-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  Isi formulir di bawah ini untuk mengirim pertanyaan.
                </p>
              </div>
            </div>
            ...
            {submitted ? (
              <div className="text-center py-10 space-y-4">
                <div className="w-16 h-16 rounded-full bg-sky-100 dark:bg-sky-950/80 text-sky-600 dark:text-sky-400 flex items-center justify-center mx-auto ring-8 ring-sky-50 dark:ring-sky-900/40">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 max-w-md mx-auto">
                    Terima kasih telah menghubungi kami, <strong>{name}</strong>. Tim Lunarys akan membalas
                    pesan Anda melalui email <strong>{email}</strong>.
                  </p>
                </div>
                <button
                  onClick={() => {
