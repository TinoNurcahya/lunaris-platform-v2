  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-xl font-bold text-slate-900">Kutipan Tersimpan</h2>
          <p className="text-xs text-slate-500">Koleksi kutipan dan lirik lagu favoritmu.</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
          ...
          <h3 className="text-base font-bold text-slate-800">Belum Ada Bookmark</h3>
          <p className="text-xs text-slate-500 mt-1 mb-4">Simpan kutipan favoritmu dengan menekan ikon bookmark.</p>
          <Link
            href="/"
