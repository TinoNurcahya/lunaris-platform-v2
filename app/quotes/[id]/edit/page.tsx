...
export default function EditQuotePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (loading) {
    return <div className="max-w-2xl mx-auto h-64 rounded-2xl bg-white border border-slate-200 animate-pulse" />;
  }
    ...
    <div className="max-w-2xl mx-auto space-y-6 pb-12">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-900">Edit Kutipan</h2>
            <p className="text-xs text-slate-500">Perbarui kutipan atau potongan lirik lagumu.</p>
          </div>
        </div>
